...
var errorOut = (data, hideWarning = false) => {
  var _a, _b;
  console.log(data);
  if (typeof data === "object" && (data == null ? void 0 : data.message))
    data = data == null ? void 0 : data.message;
  if (typeof data === "string") {
    if (!((_a = data == null ? void 0 : data.toLowerCase()) == null ? void 0 : _a.includes("warn")) && !(data == null ? void 0 : data.startsWith("error Command failed")) && !(data == null ? void 0 : data.startsWith("Exit code")) && !(data == null ? void 0 : data.startsWith("Command:")) && !(data == null ? void 0 : data.startsWith("Arguments:")) && !(data == null ? void 0 : data.startsWith("Directory:")) && !(data == null ? void 0 : data.startsWith("Output:")) && !(data == null ? void 0 : data.startsWith("The process '/usr/local/bin/yarn' failed")) && !(data == null ? void 0 : data.trim().length)) {
      import_core.default.setOutput("error", data);
      import_core.default.setFailed(data);
    } else if (!hideWarning && ((_b = data == null ? void 0 : data.toLowerCase()) == null ? void 0 : _b.includes("warn"))) {
      import_core.default.warning(data);
    } else {
      import_core.default.debug(data);
    }
  }
};
